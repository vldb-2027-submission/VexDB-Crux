...
#
# IDENTIFICATION
#    VexDBKernel/server/docker/dockerfiles/buildDockerImage.sh
#
#-------------------------------------------------------------------------
...
Builds a Docker Image for vexdb
...
# vexdb Database Image Name
IMAGE_NAME="vexdb:$VERSION"
...
docker build --force-rm=true --no-cache=true \
  ...
  echo ""
  echo "ERROR: vexdb Database Docker Image was NOT successfully created."
...
cat << EOF
  vexdb Docker Image  $VERSION is ready to be extended: 
