...
option(ENABLE_OPENBALS "enable usage of openblas lib" OFF)
option(ENABLE_TCMALLOC "enable replacement of malloc by tcmalloc" OFF)
...
configure_file(${vexdb}/cmake/src/config-in/${CONFIG_IN_FILE} ${CMAKE_BINARY_DIR}/pg_config.h @ONLY)
configure_file(${vexdb}/cmake/src/config-in/${EC_CONFIG_IN_FILE} ${CMAKE_BINARY_DIR}/ecpg_config.h @ONLY)
#set host_cpu for pgxs.mk
set(HOST_CPU ${BUILD_TUPLE})
configure_file(${vexdb}/src/makefiles/pgxs.mk ${CMAKE_BINARY_DIR}/${vexdb}/src/makefiles/pgxs.mk @ONLY)
