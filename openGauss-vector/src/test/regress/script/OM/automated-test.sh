...
logfilesavepath=/usr1/vexdbautoinstall/log
package_path_om=${workspace}/vexdb/package/vexdb-1.1.0-CentOS-64bit-om.tar.gz
package_path_app=${workspace}/vexdb/package/vexdb-1.0.1-CentOS-64bit.tar.bz2
package_path_app_sha256=${workspace}/vexdb/package/vexdb-1.0.1-CentOS-64bit.sha256
