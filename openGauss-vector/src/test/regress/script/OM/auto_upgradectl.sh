...
# username:omm  usergroup:dbgrp 工具脚本路径：/usr1/vexdbautomattest/script xml文件路径：/usr1/clusterconfig.xml
...
upgradefilepath_om=${workdir}/vexdb/package/vexdb-1.1.0-CentOS-64bit-om.tar.gz
upgradefilepath_app=${workdir}/vexdb/package/vexdb-1.0.1-CentOS-64bit.tar.bz2
upgradefilepath_app_sha256=${workdir}/vexdb/package/vexdb-1.0.1-CentOS-64bit.sha256
package_path=/home/vexdb-1.0.1-CentOS-b109-64bit.tar.gz 
...
then
        ...
        installpath=`cat ${xmlpath} | grep name=\"vexdbAppPath\"`
