    ...
    def spliceSqlFile(self, fileDir, scriptType="_"):
        try:
            ...
            if fileDir != check_upgrade_path:
                ...
                if commonScriptList:
                    errMsg = "vexdb and privategauss contain scripts of the same version number. " \
                             "Please change the version number, " \
                             "the scripts {0} in vexdb and privateGauss cannot use the same version number.".format(commonScriptList)
