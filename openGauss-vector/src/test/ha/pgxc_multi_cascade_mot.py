...
class Pterodb():
	...
	def __start_server(self):
		...
		#start data_node
		for i in range(1,self.data_node_num+1):
			datanode_cmd = g_valgrind + install_path + "/bin/vexdb --single_node" + " -M pending" + " -D " + self.data_dir + "/" + self.dname_prefix + str(i) + "   > "  + self.data_dir + "/" + self.dname_prefix + str(i) + "/logdn" + str(i) + ".log 2>&1 &"
			time.sleep(2)
                        #datanode_cmd = g_valgrind + install_path + "bin/vexdb --datanode" + " -M primary" + " -p " +str(port) + " -D " + self.data_dir + "/" + self.dname_prefix + str(i) + #" &"
			print datanode_cmd
		...
		for i in range(1,self.data_node_num+1):
			datanode_cmd = g_valgrind + install_path + "/bin/vexdb --single_node" + " -M pending "+ " -D " + self.data_dir + "/" + self.dname_prefix + str(i) + "_standby" + "   > "  + self.data_dir + "/" + self.dname_prefix + str(i) +"_standby"+ "/logdn" + str(i) + ".log 2>&1 &"
			print datanode_cmd
			os.system(datanode_cmd)
			time.sleep(5)
		...
		time.sleep(5)
                ...
                for i in range(2,self.data_node_num+1):
                        datanode_cmd = g_valgrind + install_path + "/bin/vexdb --single_node" + " -M cascade_standby "+ " -D " + self.data_dir + "/" + self.dname_prefix + str(i) + "_standby" + "   > "  + self.data_dir + "/" + self.dname_prefix + str(i) +"_standby"+ "/logdn" + str(i) + ".log 2>&1 &"
                        print datanode_cmd
                        os.system(datanode_cmd)
                        time.sleep(5)
