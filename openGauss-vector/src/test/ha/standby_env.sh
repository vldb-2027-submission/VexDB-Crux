...
db=postgres
scripts_dir=`pwd`
vector_script_dir=$scripts_dir/../regress
username=`whoami`
...
function start_multi_standby()
{
   ...
   for((i=1; i<$node_num+1; i++));do
      ...
      $bin_dir/vexdb --single_node -M standby -p $port -D $standby_dir > ./results/vexdb.log 2>&1 &
...
$bin_dir/vexdb --single_node  -M standby -p $dn1_standby_port -D $standby_data_dir $cluster_mode_param > ./results/vexdb.log 2>&1 &
check_standby_startup
}
...
$bin_dir/vexdb --single_node  -M standby -R -p $dummystandby_port -D $dummystandby_data_dir > ./results/vexdb.log 2>&1 &
sleep 10
}
...
function start_standby2()
{
  ...
  $bin_dir/vexdb --single_node -M standby -p $standby2_port -D $standby2_data_dir $cluster_mode_param > ./results/vexdb.log 2>&1 &
  sleep 10
}
...
function start_standby3()
{
  ...
  $bin_dir/vexdb --single_node -M standby -p $standby3_port -D $standby3_data_dir $cluster_mode_param > ./results/vexdb.log 2>&1 &
  sleep 10
}
...
function start_standby4()
{
  ...
  $bin_dir/vexdb --single_node -M standby -p $standby4_port -D $standby4_data_dir > ./results/vexdb.log 2>&1 &
  sleep 10
}
...
$bin_dir/vexdb --single_node  -M primary -p $dn1_primary_port -D $primary_data_dir $cluster_mode_param > ./results/vexdb.log 2>&1 &
...
$bin_dir/vexdb --single_node  -M standby -p $dn1_primary_port -D $primary_data_dir $cluster_mode_param > ./results/vexdb.log 2>&1 &
check_primary_startup
}
...
$bin_dir/vexdb --single_node  -M primary -p $dn1_standby_port -D $standby_data_dir > ./results/vexdb.log 2>&1 &
check_standby_startup
}
...
$bin_dir/vexdb --single_node  -M primary -p $standby2_port -D $standby2_data_dir $cluster_mode_param > ./results/vexdb.log 2>&1 &
...
$bin_dir/vexdb --single_node  -M pending -p $dn1_primary_port -D $primary_data_dir > ./results/vexdb.log 2>&1 &
check_primary_startup
}
...
$bin_dir/vexdb --single_node  -M pending -p $dn1_standby_port -D $standby_data_dir > ./results/vexdb.log 2>&1 &
check_standby_startup
}
...
$bin_dir/vexdb --single_node  -M cascade_standby -p $standby2_port -D $standby2_data_dir > ./results/vexdb.log 2>&1 &
...
$bin_dir/vexdb --single_node  -M cascade_standby -p $dn1_primary_port -D $primary_data_dir > ./results/vexdb.log 2>&1 &
check_primary_startup
}
