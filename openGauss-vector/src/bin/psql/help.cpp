...
void usage(void)
{
    ...
    printf(_("vsql is the VexDB Kernel interactive terminal.\n\n"));
#else
    printf(_("vsql is the vexdb interactive terminal.\n\n"));
#endif
    printf(_("Usage:\n"));
    printf(_("  vsql [OPTION]... [DBNAME [USERNAME]]\n\n"));
    ...
    printf(_("  -v, --set=, --variable=NAME=VALUE\n"
             "                           set vsql variable NAME to VALUE\n"));
    printf(_("  -V, --version            output version information, then exit\n"));
    printf(_("  -X, --no-vsqlrc          do not read startup file (~/.vsqlrc)\n"));
    ...
    printf(_("\nFor more information, type \"\\?\" (for internal commands) or \"\\help\" (for SQL\n"
             "commands) from within vsql, or consult the vsql section in the VexDB Kernel\n"
             "documentation.\n\n"));
#else
    printf(_("\nFor more information, type \"\\?\" (for internal commands) or \"\\help\" (for SQL\n"
             "commands) from within vsql, or consult the v's'q'l section in the vexdb documentation.\n\n"));
#endif
    if (user != tmp)
        free(tmp);
    tmp = NULL;
...
#if ((defined(ENABLE_MULTIPLE_NODES)) || (defined(ENABLE_PRIVATEGAUSS)))
    fprintf(output, _("  \\copyright             show VexDB Kernel usage and distribution terms\n"));
#else
    fprintf(output, _("  \\copyright             show vexdb usage and distribution terms\n"));
#endif
...
{
    puts("VexDB Kernel Database Management System\n"
