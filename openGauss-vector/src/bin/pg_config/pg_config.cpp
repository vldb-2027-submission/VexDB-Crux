...
{
    printf(("\n%s provides information about the installed version of vexdb.\n\n"), progname);
    printf(("Usage:\n"));
    printf(("  %s [OPTION]...\n\n"), progname);
    printf(("Options:\n"));
    ...
    printf(("  --configure           show options given to \"configure\" script when\n"
            "                        vexdb was built\n"));
    printf(("  --cc                  show CC value used when vexdb was built\n"));
    printf(("  --cppflags            show CPPFLAGS value used when vexdb was built\n"));
    printf(("  --cflags              show CFLAGS value used when vexdb was built\n"));
    printf(("  --cflags_sl           show CFLAGS_SL value used when vexdb was built\n"));
    printf(("  --ldflags             show LDFLAGS value used when vexdb was built\n"));
    printf(("  --ldflags_ex          show LDFLAGS_EX value used when vexdb was built\n"));
    printf(("  --ldflags_sl          show LDFLAGS_SL value used when vexdb was built\n"));
    printf(("  --libs                show LIBS value used when vexdb was built\n"));
    printf(("  --version             show the vexdb version\n"));
...
int main(int argc, char** argv)
{
    ...
    set_pglocale_pgservice(argv[0], PG_TEXTDOMAIN("vex_config"));
