...
#if PG_VERSION_NUM >= 120000
    fio_fprintf(fp, "# probackup_recovery.conf generated by vex_probackup %s\n",
                PROGRAM_VERSION);
#else
    fio_fprintf(fp, "# recovery.conf generated by vex_probackup %s\n",
                PROGRAM_VERSION);
#endif
...
pg12_recovery_config(pgBackup *backup, bool add_include)
{
    ...
    if (add_include)
    {
        ...
        fio_fprintf(fp, "\n# created by vex_probackup restore of backup %s at '%s'\n",
