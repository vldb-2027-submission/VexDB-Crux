...
static const TagStr g_tagStrArr[] = {{T_Invalid, "Invalid"},
    ...
    {T_VectorIndexScan, "VectorIndexScan"},
    {T_TextMatchIndexScan, "TextMatchIndexScan"},
    ...
    {T_VectorIndexScanState, "VectorIndexScanState"},
    {T_TextMatchIndexScanState, "TextMatchIndexScanState"},
