...
static const FormData_pg_attribute Desc_pg_ts_content[Natts_pg_ts_content] = {Schema_pg_ts_content};
...
static const FormData_pg_attribute Desc_pg_embedding_provider[Natts_pg_embedding_provider] = {Schema_pg_embedding_provider};
...
static struct CatalogRelationBuildParam catalogBuildParam[CATALOG_NUM] = {{DefaultAclRelationId,
    ...
    {TSContentRelationId,
        ...
        true},
    {EmbProvRelationId,
        "pg_embedding_provider",
        EmbProvRelation_Rowtype_Id,
        false,
        false,
        Natts_pg_embedding_provider,
        Desc_pg_embedding_provider,
        false,
        true},
    {TSParserRelationId,
        "pg_ts_parser",
...
void RelationInitIndexAccessInfo(Relation relation, HeapTuple index_tuple)
{
    ...
    if (amsupport > 0) {
        ...
        relation->rd_support = (RegProcedure*)MemoryContextAllocZero(indexcxt, nsupport * sizeof(RegProcedure)); // 空数组
