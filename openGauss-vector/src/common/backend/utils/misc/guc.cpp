...
const char* const config_group_names[] = {
    ...
    gettext_noop("Version and Platform Compatibility / Previous vexdb Versions"),
...
static void InitConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"ignore_checksum_failure",
            ...
            gettext_noop("Detection of a checksum failure normally causes vexdb to "
...
static void InitConfigureNamesString()
{
    struct config_string localConfigureNamesString[] = {
        ...
        {{"syslog_ident",
            ...
            NODE_ALL,
            LOGGING_WHERE,
            gettext_noop("Sets the program name used to identify vexdb "
                        "messages in syslog."),
            NULL},
        ...
        {{"event_source",
            ...
            gettext_noop("Sets the application name used to identify "
                        "vexdb messages in the event log."),
            NULL},
...
static void InitConfigureNamesEnum()
{
    struct config_enum localConfigureNamesEnum[] = {
        ...
        {{"remotetype",
            ...
            NODE_ALL,
            CONN_AUTH,
            gettext_noop("Sets the type of vexdb remote connection"),
            NULL},
    ...
    switch (record->vartype) {
        ...
        case PGC_STRING: {
            ...
            if (value != NULL) {
                 ...
                 * to tell new started parallel vexdb which temp namespace should use.
                 * but we should not clean the temp namespace when parallel vexdb
                 * quiting, so a flag deleteTempOnQuiting is set to prevent clean
                 * temp namespace when vexdb quiting.
                 */
...
Datum set_config_by_name(PG_FUNCTION_ARGS)
{
    ...
    if (IS_PGXC_COORDINATOR && !IsConnFromCoord() && (!is_local || IsTransactionBlock())) {
        ...
        if (PoolManagerSetCommand(poolcmdType, poolcmd.data) < 0)
            ereport(ERROR, (errcode(ERRCODE_SET_QUERY), errmsg("vexdb: ERROR SET query")));
    }
