...
static void InitStorageConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"diskann_query_with_pq",
            PGC_USERSET,
            NODE_ALL,
            CUSTOM_OPTIONS,
            gettext_noop("Enforces query with PQ data for DiskANN"),
            NULL},
            &u_sess->attr.attr_storage.diskann_query_with_pq,
            false,
            NULL,
            NULL,
            NULL},
...
static void InitStorageConfigureNamesInt()
{
    struct config_int localConfigureNamesInt[] = {
        ...
        {{"ivf_probes",
            ...
            GUC_LIST_INPUT},
            &u_sess->attr.attr_storage.ivf_probes,
            1,
            1,
            65535,
            NULL,
            NULL,
            NULL}, // 插件调用的函数中flags参数是0

        {{"ef_search",
            PGC_USERSET,
            NODE_ALL,
            CUSTOM_OPTIONS,
            gettext_noop("Sets the size of the dynamic candidate list for index search"),
            gettext_noop("Valid range is 1..32767."),
            GUC_LIST_INPUT},
            &u_sess->attr.attr_storage.ef_search,
            100,
            1,
            32767,
            NULL,
        ...
        {{"diskann_num_cached_nodes",
            PGC_POSTMASTER,
            NODE_ALL,
            CUSTOM_OPTIONS,
            gettext_noop("Sets the number of cached diskann nodes during index scan"),
            gettext_noop("Valid range is 0..1000.")},
            &g_instance.diskann_cxt.max_cache_size,
        ...
        {{"vector_buffers",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the memory of vector buffers used by the server."),
            NULL,
            GUC_UNIT_KB},
            &g_instance.diskann_cxt.vector_buffers,
            DEFAULT_VECTOR_BUFFERS,
            64 * 1024,
            INT_MAX / 2,
            NULL,
            NULL,
        ...
        {{"vector_buffer_thread_num",
            ...
            NODE_ALL,
            RESOURCES_MEM,
            gettext_noop("Sets the number of vector buffer manager threads."),
            NULL,
            0},
            ...
            NULL,
            NULL},
        {{"max_vector_indexer_worker_threads",
            PGC_POSTMASTER,
            NODE_ALL,
            RESOURCES,
            gettext_noop("Sets the maximum number of vector indexer worker threads."),
            NULL,
            0},
        ...
        {{"max_vector_indexer_query_threads",
            ...
            NODE_ALL,
            RESOURCES,
            gettext_noop("Sets the maximum number of vector indexer query threads."),
            NULL,
            0},
        ...
        {{"ivf_extend_file_block_batch_count",
            PGC_SIGHUP,
            NODE_ALL,
            SHARED_STORAGE_OPTIONS,
            gettext_noop("Sets the batch count for ivf extending file block."),
            NULL},
            &g_instance.attr.attr_storage.ivf_extend_file_block_batch_count,
            64,
            1,
            1024,
            NULL,
...
static void InitStorageConfigureNamesReal()
{
    struct config_real localConfigureNamesReal[] = {
        ...
        {{"checkpoint_completion_target",
            ...
            NULL,
            NULL},
         {{"ivfpq_refine_k_factor",
            PGC_USERSET,
            NODE_ALL,
            CUSTOM_OPTIONS,
            gettext_noop(
                "Sets the k factor for ivfpq to refine distance sort."),
            NULL},
            &u_sess->attr.attr_storage.ivfpq_refine_k_factor,
            2.0,
            1.0,
            10000.0,
            NULL,
            NULL,
            NULL},
            {{"hybrid_query_ivf_probes_factor",
            PGC_USERSET,
            NODE_ALL,
            CUSTOM_OPTIONS,
            gettext_noop(
                "Sets ivf probes relative to ivf nlists"),
            NULL},
            &u_sess->attr.attr_storage.hybrid_query_ivf_probes_factor,
            3.0,
            1.0,
            100.0,
            NULL,
...
static bool check_autovacuum_max_workers(int* newval, void** extra, GucSource source)
{
    if (g_instance.attr.attr_network.MaxConnections + *newval + g_instance.attr.attr_sql.job_queue_processes +
        AUXILIARY_BACKENDS + AV_LAUNCHER_PROCS + g_instance.diskann_cxt.max_indexer_worker_threads +
        g_instance.diskann_cxt.max_indexer_query_threads +
