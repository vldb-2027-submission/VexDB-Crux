...
typedef struct PlannerInfo {
    ...
    bool hasIndexProvided;       /* ture if index contains special result */
...
typedef struct EquivalenceClass {
    ...
    bool ec_has_non_index_volatile;     /* the (sole) member is a volatile and non-index-provided expr */
 ...
 * NOTE: VexDB keep an subplan other than the sub-path
 */
