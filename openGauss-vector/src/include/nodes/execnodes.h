...
typedef struct VectorIndexScanState : public IndexScanState {
    double score;
    bool with_limit{false};
    int64 limit_offset;            /* current OFFSET value */
    int64 limit_count;             /* current COUNT, if any */
} VectorIndexScanState;

typedef struct TextMatchIndexScanState : public IndexScanState {
    float score;
    bool with_limit{false};
    int64 limit_offset;            /* current OFFSET value */
    int64 limit_count;             /* current COUNT, if any */
} TextMatchIndexScanState;
