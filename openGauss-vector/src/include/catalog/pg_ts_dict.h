...
DATA(insert OID = 3885 ( "cn_tokenizer" PGNSP PGUID 3884 "stopwords = ''default'', userdict = ''default''"));
DESCR("vex_jieba dictionary: tokenize chinese-english mixed sentences with vex_jieba and then process english with snowball");
