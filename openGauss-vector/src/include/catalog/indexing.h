...
DECLARE_UNIQUE_INDEX(pg_ts_content_oid_index, 3629, on pg_ts_content using btree(dictoid oid_ops, type char_ops));
#define TSContentOidTypeIndexId	3629

DECLARE_UNIQUE_INDEX(pg_embedding_provider_servname_index, 3636, on pg_embedding_provider using btree(service_name name_ops));
#define EMBPROVSERNAMEIndexId	3636
