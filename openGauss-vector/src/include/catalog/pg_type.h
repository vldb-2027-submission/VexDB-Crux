...
/* data_vector (same as pgvector)*/
DATA(insert OID = 5036 ( floatvector        PGNSP PGUID  -1 f b U f t \054 0 0 0    floatvector_in floatvector_out floatvector_recv floatvector_send floatvector_typmod_in floatvector_typmod_out - i x t 0 -1 0 0 _null_ _null_ _null_ ));
DESCR("a type for floatvector using");
#define FLOATVECTOROID 5036

DATA(insert OID = 5068 ( halfvector        PGNSP PGUID  -1 f b U f t \054 0 0 0    halfvector_in halfvector_out halfvector_recv halfvector_send halfvector_typmod_in halfvector_typmod_out - i x t 0 -1 0 0 _null_ _null_ _null_ ));
#define HALFVECTOROID 5068

DATA(insert OID = 5037 ( sparsevector       PGNSP PGUID  -1 f b U f t \054 0 0 0    sparsevector_in sparsevector_out sparsevector_recv sparsevector_send - - - i x t 0 -1 0 0 _null_ _null_ _null_ ));
#define SPARSEVECTOROID 5037
