...
DATA(insert OID = 8289 ( 1976   23 5545 1 6132 ));
...
DATA(insert OID = 8290 (	5535   5545 23 1 6133 ));
DATA(insert OID = 8302 (	5535   23 23 1 450 ));
DATA(insert (	5536   5545 5545 1 5520 ));
DATA(insert OID = 8291 (	5536   23 23 1 450 ));
DATA(insert OID = 8286 (	7893   5036 5036 1 5059 ));
DATA(insert OID = 8287 (	7893   5036 5036 2 5066 ));
DATA(insert OID = 8288 (	7893   5036 5036 3 4608 ));

DATA(insert OID = 8018 (	7897   5068 5068 1 4558 ));
DATA(insert OID = 8019 (	7897   5068 5068 2 4559 ));
DATA(insert OID = 8020 (	7897   5068 5068 3 4608 ));
...
DATA(insert OID = 8298 (	1977   5545 5545 1 5520 ));
...
DATA(insert OID = 8285 (	7894   5036 5036 1 5067 ));
DATA(insert OID = 8021 (	7898   5068 5068 1 4589 ));
...
/* ivfflat floatvector_l2_ops*/
DATA(insert OID = 7821 (	7816   5036 5036 1 5044 ));
DATA(insert OID = 7822 (	7816   5036 5036 3 5042 ));

/* ivfflat floatvector_cosine_ops*/
DATA(insert OID = 7823 (	7817   5036 5036 1 5046 ));
DATA(insert OID = 7824 (	7817   5036 5036 2 5050 ));
DATA(insert OID = 7825 (	7817   5036 5036 3 5048 ));
DATA(insert OID = 7826 (	7817   5036 5036 4 5050 ));

/* ivfflat floatvector_ip_ops*/
DATA(insert OID = 7833 (	7836   5036 5036 1 5046 ));
DATA(insert OID = 7834 (	7836   5036 5036 3 5048 ));
DATA(insert OID = 7835 (	7836   5036 5036 4 5050 ));

/* ivfpq floatvector_l2_ops*/
DATA(insert OID = 7827 (	7879   5036 5036 1 5044 ));
DATA(insert OID = 7828 (	7879   5036 5036 3 5042 ));

/* ivfpq floatvector_cosine_ops*/
DATA(insert OID = 7829 (	7880   5036 5036 1 5044 ));
DATA(insert OID = 7830 (	7880   5036 5036 2 5050 ));
DATA(insert OID = 7831 (	7880   5036 5036 3 5042 ));
DATA(insert OID = 7832 (	7880   5036 5036 4 5050 ));

/* ivfpq floatvector_ip_ops*/
DATA(insert OID = 7840 (	7838   5036 5036 1 5046 ));
DATA(insert OID = 7842 (	7838   5036 5036 3 5048 ));
DATA(insert OID = 7843 (	7838   5036 5036 4 5050 ));
DATA(insert OID = 7847 (	7838   5036 5036 5 5042 ));

/* hnsw floatvector_l2_ops*/
DATA(insert (	7818   5036 5036 1 5044 ));

/* hnsw floatvector_cosine_ops*/
DATA(insert (	8007   5036 5036 1 5046 ));
DATA(insert (	8007   5036 5036 2 5050 ));

/* hnsw floatvector_ip_ops*/
DATA(insert (	8008   5036 5036 1 5046 ));

/* graph_index floatvecor */
DATA(insert OID = 8275 (	7889   5036 5036 1 5044 ));
DATA(insert OID = 8276 (	7890   5036 5036 1 5046 ));
DATA(insert OID = 8277 (	7890   5036 5036 2 5050 ));
DATA(insert OID = 8278 (	7891   5036 5036 1 5046 ));

/* graph_index  halfvec */
DATA(insert OID = 8392 (	7900   5068 5068 1 4566 ));
DATA(insert OID = 8393 (	7901   5068 5068 1 4575 ));
DATA(insert OID = 8394 (	7901   5068 5068 2 4576 ));
DATA(insert OID = 8395 (	7902   5068 5068 1 4575 ));

/* diskann diskann_floatvector_l2_ops*/
DATA(insert OID = 7844 (	7819   5036 5036 1 5042 ));
DATA(insert OID = 7845 (	7820   5036 5036 1 5047 ));
DATA(insert OID = 7846 (	7821   5036 5036 1 5046 ));
/* diskann multi-column ops */
/* diskann operators int2 */
DATA(insert OID = 8188 ( 7802   21 21 1 148 ));
DATA(insert OID = 8209 ( 7802   21 21 2 350 ));
/* diskann operators int4 */
DATA(insert OID = 8189 ( 7802   23 23 1 149 ));
DATA(insert OID = 8210 ( 7802   23 23 2 351 ));
/* diskann default operators int8 */
DATA(insert OID = 8190 ( 7802   20 20 1 471 ));
DATA(insert OID = 8211 ( 7802   20 20 2 842 ));
/* diskann oid_ops */
DATA(insert OID = 8191 ( 7807   26 26 1 717 ));
DATA(insert OID = 8212 ( 7807   26 26 2 356 ));
/* diskann operators date */
DATA(insert OID = 8192 ( 7814   1082 1082 1 1088 ));
DATA(insert OID = 8213 ( 7814   1082 1082 2 1092 ));
/* diskann operators timestamp */
DATA(insert OID = 8193 ( 7814   1114 1114 1 2055 ));
DATA(insert OID = 8214 ( 7814   1114 1114 2 2045 ));
/* diskann operators timestamptz */
DATA(insert OID = 8194 ( 7814   1184 1184 1 1155 ));
DATA(insert OID = 8215 ( 7814   1184 1184 2 1314 ));
/* diskann time_ops */
DATA(insert OID = 8195 ( 7850   1083 1083 1 1103 ));
DATA(insert OID = 8216 ( 7850   1083 1083 2 1107 ));
/* diskann timetz_ops */
DATA(insert OID = 8196 ( 7851   1266 1266 1 1355 ));
DATA(insert OID = 8217 ( 7851   1266 1266 2 1358 ));
/* diskann operators float4 */
DATA(insert OID = 8197 ( 7839   700 700 1 290 ));
DATA(insert OID = 8218 ( 7839   700 700 2 354 ));
/* diskann operators float8 */
DATA(insert OID = 8198 ( 7839   701 701 1 296 ));
DATA(insert OID = 8219 ( 7839   701 701 2 355 ));
/* diskann char_ops */
DATA(insert OID = 8199 ( 7858   18 18 1  72 ));
DATA(insert OID = 8220 ( 7858   18 18 2  358 ));
/* diskann name_ops */
DATA(insert OID = 8200 ( 7859   19 19 1 656 ));
DATA(insert OID = 8221 ( 7859   19 19 2 359 ));
/* diskann text_ops */
DATA(insert OID = 8201 ( 7848   25 25 1 741 ));
DATA(insert OID = 8222 ( 7848   25 25 2 360 ));
/* diskann bpchar_ops */
DATA(insert OID = 8202 ( 7849   1042 1042 1 1050 ));
DATA(insert OID = 8223 ( 7849   1042 1042 2 1078 ));
/* diskann bytea_ops */
DATA(insert OID = 8203 ( 7860   17 17 1 1950 ));
DATA(insert OID = 8224 ( 7860   17 17 2 1954 ));
/* diskann numeric */
DATA(insert OID = 8204 ( 7861   1700 1700 1 1723 ));
DATA(insert OID = 8225 ( 7861   1700 1700 2 1769 ));
/* diskann interval_ops */
DATA(insert OID = 8205 ( 7853   1186 1186 1 1165 ));
DATA(insert OID = 8226 ( 7853   1186 1186 2 1315 ));
/* diskann int1_ops */
DATA(insert OID = 8206 ( 7855 5545 5545 1 5510 ));
DATA(insert OID = 8227 ( 7855 5545 5545 2 5519 ));
/* diskann bool_ops */
DATA(insert OID = 8207 ( 7856 16 16 1 1691 ));
DATA(insert OID = 8228 ( 7856 16 16 2 1693 ));
/* diskann enum_ops */
DATA(insert OID = 8208 ( 7857 3500 3500 1 3512 ));
DATA(insert OID = 8229 ( 7857 3500 3500 2 3514 ));

/* hybridann floatvector ops*/
DATA(insert OID = 8230 (	7868   5036 5036 1 5042 ));
DATA(insert OID = 8231 (	7869   5036 5036 1 5047 ));
DATA(insert OID = 8279 (	7869   5036 5036 2 5050 ));
DATA(insert OID = 8232 (	7870   5036 5036 1 5046 ));
/* hybridann multi-column ops */
/* hybridann operators int2 */
DATA(insert OID = 8233 ( 7871   21 21 1 148 ));
DATA(insert OID = 8234 ( 7871   21 21 2 350 ));
/* hybridann operators int4 */
DATA(insert OID = 8235 ( 7871   23 23 1 149 ));
DATA(insert OID = 8236 ( 7871   23 23 2 351 ));
/* hybridann default operators int8 */
DATA(insert OID = 8237 ( 7871   20 20 1 471 ));
DATA(insert OID = 8238 ( 7871   20 20 2 842 ));
/* hybridann oid_ops */
DATA(insert OID = 8239 ( 7872   26 26 1 717 ));
DATA(insert OID = 8240 ( 7872   26 26 2 356 ));
/* hybridann operators date */
DATA(insert OID = 8241 ( 7873   1082 1082 1 1088 ));
DATA(insert OID = 8242 ( 7873   1082 1082 2 1092 ));
/* hybridann operators timestamp */
DATA(insert OID = 8243 ( 7873   1114 1114 1 2055 ));
DATA(insert OID = 8244 ( 7873   1114 1114 2 2045 ));
/* hybridann operators timestamptz */
DATA(insert OID = 8245 ( 7873   1184 1184 1 1155 ));
DATA(insert OID = 8246 ( 7873   1184 1184 2 1314 ));
/* hybridann time_ops */
DATA(insert OID = 8247 ( 7874   1083 1083 1 1103 ));
DATA(insert OID = 8248 ( 7874   1083 1083 2 1107 ));
/* hybridann timetz_ops */
DATA(insert OID = 8249 ( 7875   1266 1266 1 1355 ));
DATA(insert OID = 8250 ( 7875   1266 1266 2 1358 ));
/* hybridann operators float4 */
DATA(insert OID = 8251 ( 7876   700 700 1 290 ));
DATA(insert OID = 8252 ( 7876   700 700 2 354 ));
/* hybridann operators float8 */
DATA(insert OID = 8253 ( 7876   701 701 1 296 ));
DATA(insert OID = 8254 ( 7876   701 701 2 355 ));
/* hybridann char_ops */
DATA(insert OID = 8255 ( 7877   18 18 1  72 ));
DATA(insert OID = 8256 ( 7877   18 18 2  358 ));
/* hybridann name_ops */
DATA(insert OID = 8257 ( 7878   19 19 1 656 ));
DATA(insert OID = 8258 ( 7878   19 19 2 359 ));
/* hybridann text_ops */
DATA(insert OID = 8259 ( 7887   25 25 1 741 ));
DATA(insert OID = 8260 ( 7887   25 25 2 360 ));
/* hybridann bpchar_ops */
DATA(insert OID = 8261 ( 7888   1042 1042 1 1050 ));
DATA(insert OID = 8262 ( 7888   1042 1042 2 1078 ));
/* hybridann bytea_ops */
DATA(insert OID = 8263 ( 7881   17 17 1 1950 ));
DATA(insert OID = 8264 ( 7881   17 17 2 1954 ));
/* hybridann numeric */
DATA(insert OID = 8265 ( 7882   1700 1700 1 1723 ));
DATA(insert OID = 8266 ( 7882   1700 1700 2 1769 ));
/* hybridann interval_ops */
DATA(insert OID = 8267 ( 7883   1186 1186 1 1165 ));
DATA(insert OID = 8268 ( 7883   1186 1186 2 1315 ));
/* hybridann int1_ops */
DATA(insert OID = 8269 ( 7884 5545 5545 1 5510 ));
DATA(insert OID = 8270 ( 7884 5545 5545 2 5519 ));
DATA(insert OID = 8292 ( 7884 5545 23 1 6123 ));
DATA(insert OID = 8299 ( 7884 21 21 2 350 ));
DATA(insert OID = 8300 ( 7884 23 23 2 351 ));
DATA(insert OID = 8301 ( 7884 20 20 2 842 ));
/* hybridann bool_ops */
DATA(insert OID = 8271 ( 7885 16 16 1 1691 ));
DATA(insert OID = 8272 ( 7885 16 16 2 1693 ));
/* hybridann enum_ops */
DATA(insert OID = 8273 ( 7886 3500 3500 1 3512 ));
DATA(insert OID = 8274 ( 7886 3500 3500 2 3514 ));
/* hybridann uuid_ops */
DATA(insert OID = 8280 ( 7892 2950 2950 1 2955 ));
DATA(insert OID = 8281 ( 7892 2950 2950 2 2960 ));
...
DATA(insert OID = 8294 ( 4062 5545 23 1 6123 ));
...
DATA(insert OID = 8295 ( 4262 5545 23 1 6123 ));
...
DATA(insert OID = 8297 ( 6976   23 5545 1 6132 ));
...
DATA(insert OID = 8296 ( 9535 5545 23 1 6123 ));
...
DATA(insert OID = 8282 (	7895   5036 5036 1 5059 ));
DATA(insert OID = 8283 (	7895   5036 5036 2 5066 ));
DATA(insert OID = 8284 (	7895   5036 5036 3 4608 ));

DATA(insert OID = 8022 (	7899   5068 5068 1 4558 ));
DATA(insert OID = 8023 (	7899   5068 5068 2 4559 ));
DATA(insert OID = 8024 (	7899   5068 5068 3 4608 ));
