...
/* ivfflat + floatvector*/
DATA(insert OID = 7816 (439        floatvector_l2_ops        PGNSP PGUID));
DATA(insert OID = 7817 (439        floatvector_cosine_ops        PGNSP PGUID));
DATA(insert OID = 7836 (439        floatvector_ip_ops        PGNSP PGUID));

/* ivfpq + floatvector*/
DATA(insert OID = 7879 (506        floatvector_l2_ops        PGNSP PGUID));
DATA(insert OID = 7880 (506        floatvector_cosine_ops        PGNSP PGUID));
DATA(insert OID = 7838 (506        floatvector_ip_ops        PGNSP PGUID));

/* hnsw + floatvector*/
DATA(insert OID = 7818 (494        floatvector_l2_ops        PGNSP PGUID));
DATA(insert OID = 8007 (494        floatvector_cosine_ops        PGNSP PGUID));
DATA(insert OID = 8008 (494        floatvector_ip_ops        PGNSP PGUID));

/* diskann + floatvector*/
DATA(insert OID = 7819 (4471       floatvector_l2_ops        PGNSP PGUID));
DATA(insert OID = 7820 (4471       floatvector_cosine_ops        PGNSP PGUID));
DATA(insert OID = 7821 (4471       floatvector_ip_ops        PGNSP PGUID));
/* diskann + other */
DATA(insert OID = 7802 (4471    integer_ops      PGNSP    PGUID));
DATA(insert OID = 7807 (4471    oid_ops          PGNSP    PGUID));
DATA(insert OID = 7814 (4471    datetime_ops     PGNSP    PGUID));
DATA(insert OID = 7850 (4471    time_ops         PGNSP    PGUID));
DATA(insert OID = 7851 (4471    timetz_ops       PGNSP    PGUID));
DATA(insert OID = 7839 (4471    float_ops        PGNSP    PGUID));
DATA(insert OID = 7858 (4471    char_ops        PGNSP PGUID));
DATA(insert OID = 7859 (4471    name_ops        PGNSP PGUID));
DATA(insert OID = 7848 (4471    text_ops         PGNSP    PGUID));
DATA(insert OID = 7849 (4471    bpchar_ops       PGNSP    PGUID));
DATA(insert OID = 7860 (4471    bytea_ops        PGNSP PGUID));
DATA(insert OID = 7861 (4471    numeric_ops      PGNSP    PGUID));
DATA(insert OID = 7853 (4471    interval_ops     PGNSP    PGUID));
DATA(insert OID = 7855 (4471    int1_ops         PGNSP    PGUID));
DATA(insert OID = 7856 (4471    bool_ops         PGNSP    PGUID));
DATA(insert OID = 7857 (4471    enum_ops         PGNSP    PGUID));

DATA(insert OID = 7862 (4429    bm25_rank_char_ops  PGNSP   PGUID));
DATA(insert OID = 7863 (4429    bm25_rank_varchar_ops  PGNSP   PGUID));
DATA(insert OID = 7864 (4429    bm25_rank_text_ops  PGNSP   PGUID));
DATA(insert OID = 7865 (4429    bm25_rank_chararr_ops  PGNSP   PGUID));
DATA(insert OID = 7866 (4429    bm25_rank_varchararr_ops  PGNSP   PGUID));
DATA(insert OID = 7867 (4429    bm25_rank_textarr_ops  PGNSP   PGUID));

/* hybridann + floatvector*/
DATA(insert OID = 7868 (4434       floatvector_l2_ops        PGNSP PGUID));
DATA(insert OID = 7869 (4434       floatvector_cosine_ops        PGNSP PGUID));
DATA(insert OID = 7870 (4434       floatvector_ip_ops        PGNSP PGUID));
/* hybridann + other */
DATA(insert OID = 7871 (4434    integer_ops      PGNSP    PGUID));
DATA(insert OID = 7872 (4434    oid_ops          PGNSP    PGUID));
DATA(insert OID = 7873 (4434    datetime_ops     PGNSP    PGUID));
DATA(insert OID = 7874 (4434    time_ops         PGNSP    PGUID));
DATA(insert OID = 7875 (4434    timetz_ops       PGNSP    PGUID));
DATA(insert OID = 7876 (4434    float_ops        PGNSP    PGUID));
DATA(insert OID = 7877 (4434    char_ops        PGNSP PGUID));
DATA(insert OID = 7878 (4434    name_ops        PGNSP PGUID));
#define NAME_HYBRIDANN_FAM_OID 7878
DATA(insert OID = 7887 (4434    text_ops         PGNSP    PGUID));
#define TEXT_HYBRIDANN_FAM_OID 7887
DATA(insert OID = 7888 (4434    bpchar_ops       PGNSP    PGUID));
#define BPCHAR_HYBRIDANN_FAM_OID 7888
DATA(insert OID = 7881 (4434    bytea_ops        PGNSP PGUID));
#define BYTEA_HYBRIDANN_FAM_OID 7881
DATA(insert OID = 7882 (4434    numeric_ops      PGNSP    PGUID));
DATA(insert OID = 7883 (4434    interval_ops     PGNSP    PGUID));
DATA(insert OID = 7884 (4434    int1_ops         PGNSP    PGUID));
DATA(insert OID = 7885 (4434    bool_ops         PGNSP    PGUID));
#define BOOL_HYBRIDANN_FAM_OID 7885
DATA(insert OID = 7886 (4434    enum_ops         PGNSP    PGUID));
DATA(insert OID = 7892 (4434    uuid_ops        PGNSP PGUID));

/* graph_index + FloatVector */
DATA(insert OID = 7889 (4387    floatvector_l2_ops      PGNSP PGUID));
DATA(insert OID = 7890 (4387    floatvector_cosine_ops  PGNSP PGUID));
DATA(insert OID = 7891 (4387    floatvector_ip_ops      PGNSP PGUID));

/* graph_index + halfvec */
DATA(insert OID = 7900 (4387    halfvector_l2_ops      PGNSP PGUID));
DATA(insert OID = 7901 (4387    halfvector_cosine_ops  PGNSP PGUID));
DATA(insert OID = 7902 (4387    halfvector_ip_ops      PGNSP PGUID));

/* FloatVector */
DATA(insert OID = 7893 (403     floatvector_ops     PGNSP PGUID));
DATA(insert OID = 7894 (405     floatvector_ops     PGNSP PGUID));
DATA(insert OID = 7895 (4439    floatvector_ops     PGNSP PGUID));

/* halfvector */
DATA(insert OID = 7897 (403     halfvector_ops     PGNSP PGUID));
DATA(insert OID = 7898 (405     halfvector_ops     PGNSP PGUID));
DATA(insert OID = 7899 (4439    halfvector_ops     PGNSP PGUID));

/* sparsevector */
DATA(insert OID = 7903 (4429    sparsevector_cosine_ops PGNSP PGUID));
#define SPARSEVEC_COSINE_FULLTEXT_FAM_OID 7903
DATA(insert OID = 7904 (4429    sparsevector_ip_ops     PGNSP PGUID));
#define SPARSEVEC_IP_FULLTEXT_FAM_OID 7904
