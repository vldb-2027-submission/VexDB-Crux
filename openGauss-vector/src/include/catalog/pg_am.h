...
DATA(insert OID = 506 (  ivfpq		0 5 t t f f f t f f t f t 0 ivfpqinsert ivfpqbeginscan ivfpqgettuple - ivfpqrescan ivfpqendscan - - - ivfpqbuild ivfpqbuildempty ivfpqbulkdelete ivfpqvacuumcleanup - ivfpqcostestimate ivfpqoptions));
DESCR("ivfpq index access method");
#define IVFPQ_AM_OID 506
...
DATA(insert OID = 4471 (  diskann		0 2 f t f f t t t f f f f 0 diskanninsert diskannbeginscan diskanngettuple - diskannrescan diskannendscan - - - diskannbuild diskannbuildempty diskannbulkdelete diskannvacuumcleanup - diskanncostestimate diskannoptions));
DESCR("diskann index access method");
#define diskann_AM_OID 4471

DATA(insert OID = 4387 (  graph_index		0 3 f t f f f t f f f f f 0 hnswinsert hnswbeginscan hnswgettuple - hnswrescan hnswendscan - - - hnswbuild hnswbuildempty hnswbulkdelete hnswvacuumcleanup - hnswcostestimate hnswoptions));
DESCR("graph_index index access method");
#define graph_index_AM_OID 4387

DATA(insert OID = 4434 (  hybridann		0 3 f t f f t t t f f f f 0 hybridanninsert hybridannbeginscan hybridanngettuple - hybridannrescan hybridannendscan - - - hybridannbuild hybridannbuildempty hybridannbulkdelete hybridannvacuumcleanup - hybridanncostestimate hybridannoptions));
DESCR("hybridann index access method");
#define hybridann_AM_OID 4434

DATA(insert OID = 494 (  hnsw		0 3 f t f f f t f f f f f 0 hnswinsert hnswbeginscan hnswgettuple - hnswrescan hnswendscan - - - hnswbuild hnswbuildempty hnswbulkdelete hnswvacuumcleanup - hnswcostestimate hnswoptions));
DESCR("hnsw index access method");
#define hnsw_AM_OID 494

DATA(insert OID = 4429 (  fulltext		0 0 f t f f t t f f f f f 0 bm25insert bm25beginscan bm25gettuple - bm25rescan bm25endscan - - - bm25build bm25buildempty bm25bulkdelete bm25vacuumcleanup - bm25costestimate bm25options));
DESCR("fulltext index access method");
