...
DATA(insert OID = 1135 ( 403 floatvector_ops    PGNSP PGUID 7893  5036 t 0 ));
DATA(insert OID = 1136 ( 405 floatvector_ops    PGNSP PGUID 7894  5036 t 0 ));
DATA(insert OID = 1137 ( 4439 floatvector_ops   PGNSP PGUID 7895  5036 t 0 ));

/* halfvec operators */
DATA(insert OID = 1201 ( 403 halfvector_ops    PGNSP PGUID 7897  5068 t 0 ));
DATA(insert OID = 1202 ( 405 halfvector_ops    PGNSP PGUID 7898  5068 t 0 ));
DATA(insert OID = 1203 ( 4439 halfvector_ops   PGNSP PGUID 7899  5068 t 0 ));
...
// ivfflat
DATA(insert OID = 1072 ( 439 floatvector_l2_ops PGNSP PGUID 7816  5036 t 0 ));
DATA(insert ( 439 floatvector_cosine_ops PGNSP PGUID 7817  5036 f 0 ));
DATA(insert OID = 7837 ( 439 floatvector_ip_ops PGNSP PGUID 7836  5036 f 0 ));

// ivfpq
DATA(insert OID = 1075 ( 506 floatvector_l2_ops PGNSP PGUID 7879  5036 t 0 ));
DATA(insert OID = 1076 ( 506 floatvector_cosine_ops PGNSP PGUID 7880  5036 f 0 ));
DATA(insert OID = 7844 ( 506 floatvector_ip_ops PGNSP PGUID 7838  5036 f 0 ));
// hnsw
DATA(insert OID = 1074 ( 494 floatvector_l2_ops PGNSP PGUID 7818  5036 t 0 ));
DATA(insert OID = 8005 ( 494 floatvector_cosine_ops PGNSP PGUID 8007  5036 f 0 ));
DATA(insert OID = 8006 ( 494 floatvector_ip_ops PGNSP PGUID 8008  5036 f 0 ));
// graph_index floatvector
DATA(insert OID = 1131 ( 4387 floatvector_l2_ops PGNSP PGUID 7889  5036 t 0 ));
DATA(insert OID = 1132 ( 4387 floatvector_cosine_ops PGNSP PGUID 7890  5036 f 0 ));
DATA(insert OID = 1133 ( 4387 floatvector_ip_ops PGNSP PGUID 7891  5036 f 0 ));

// graph_index halfvec
DATA(insert OID = 1141 ( 4387 halfvector_l2_ops PGNSP PGUID 7900  5068 t 0 ));
DATA(insert OID = 1139 ( 4387 halfvector_cosine_ops PGNSP PGUID 7901  5068 f 0 ));
DATA(insert OID = 1140 ( 4387 halfvector_ip_ops PGNSP PGUID 7902  5068 f 0 ));

// diskann
DATA(insert OID = 1077 ( 4471 floatvector_l2_ops PGNSP PGUID 7819  5036 t 0 ));
DATA(insert OID = 1078 ( 4471 floatvector_cosine_ops PGNSP PGUID 7820  5036 f 0 ));
DATA(insert OID = 1079 ( 4471 floatvector_ip_ops PGNSP PGUID 7821  5036 f 0 ));
DATA(insert OID = 1080 ( 4471 bool_ops    PGNSP PGUID 7856   16 t 0 ));
DATA(insert OID = 1081 ( 4471 bpchar_ops  PGNSP PGUID 7849 1042 t 0 ));
DATA(insert OID = 1082 ( 4471 bytea_ops   PGNSP PGUID 7860   17 t 0 ));
DATA(insert OID = 1083 ( 4471 char_ops    PGNSP PGUID 7858   18 t 0 ));
DATA(insert OID = 1084 ( 4471 date_ops    PGNSP PGUID 7814 1082 t 0 ));
DATA(insert OID = 1085 ( 4471 float4_ops  PGNSP PGUID 7839  700 t 0 ));
DATA(insert OID = 1086 ( 4471 float8_ops  PGNSP PGUID 7839  701 t 0 ));
DATA(insert OID = 1087 ( 4471 int2_ops    PGNSP PGUID 7802   21 t 0 ));
DATA(insert OID = 1088 ( 4471 int4_ops    PGNSP PGUID 7802   23 t 0 ));
DATA(insert OID = 1089 ( 4471 int8_ops    PGNSP PGUID 7802   20 t 0 ));
DATA(insert OID = 1090 ( 4471 name_ops    PGNSP PGUID 7859   19 t 2275 ));
DATA(insert OID = 1091 ( 4471 numeric_ops PGNSP PGUID 7861 1700 t 0 ));
DATA(insert OID = 1092 ( 4471 oid_ops     PGNSP PGUID 7807   26 t 0 ));
DATA(insert OID = 1093 ( 4471 text_ops    PGNSP PGUID 7848   25 t 0 ));
DATA(insert OID = 1094 ( 4471 time_ops    PGNSP PGUID 7850 1083 t 0 ));
DATA(insert OID = 1095 ( 4471 timestamptz_ops PGNSP PGUID 7814 1184 t 0 ));
DATA(insert OID = 1096 ( 4471 timetz_ops  PGNSP PGUID 7851 1266 t 0 ));
DATA(insert OID = 1097 ( 4471 varchar_ops PGNSP PGUID 7848   25 f 0 ));
DATA(insert OID = 1098 ( 4471 timestamp_ops   PGNSP PGUID 7814 1114 t 0 ));
DATA(insert OID = 1099 ( 4471 enum_ops    PGNSP PGUID 7857  3500 t 0 ));
DATA(insert OID = 1100 ( 4471 int1_ops    PGNSP PGUID 7855  5545 t 0 ));

/* bm25 */
DATA(insert OID = 1101 ( 4429 bm25_rank_char_ops PGNSP PGUID 7862  1042 t 0 ));
DATA(insert OID = 1102 ( 4429 bm25_rank_varchar_ops PGNSP PGUID 7863  1043 t 0 ));
DATA(insert OID = 1103 ( 4429 bm25_rank_text_ops PGNSP PGUID 7864  25 t 0 ));
DATA(insert OID = 1104 ( 4429 bm25_rank_chararr_ops PGNSP PGUID 7865  1014 t 0 ));
DATA(insert OID = 1105 ( 4429 bm25_rank_varchararr_ops PGNSP PGUID 7866  1015 t 0 ));
DATA(insert OID = 1106 ( 4429 bm25_rank_textarr_ops PGNSP PGUID 7867  1009 t 0 ));
DATA(insert OID = 1142 ( 4429 sparsevector_ip_ops PGNSP PGUID 7904  5037 t 0 ));
DATA(insert OID = 1143 ( 4429 sparsevector_cosine_ops PGNSP PGUID 7903  5037 f 0 ));

// hybridann
DATA(insert OID = 1107 ( 4434 floatvector_l2_ops PGNSP PGUID 7868  5036 t 0 ));
DATA(insert OID = 1108 ( 4434 floatvector_cosine_ops PGNSP PGUID 7869  5036 f 0 ));
DATA(insert OID = 1109 ( 4434 floatvector_ip_ops PGNSP PGUID 7870  5036 f 0 ));
DATA(insert OID = 1110 ( 4434 bool_ops    PGNSP PGUID 7885   16 t 0 ));
DATA(insert OID = 1111 ( 4434 bpchar_ops  PGNSP PGUID 7888 1042 t 0 ));
DATA(insert OID = 1112 ( 4434 bytea_ops   PGNSP PGUID 7881   17 t 0 ));
DATA(insert OID = 1113 ( 4434 char_ops    PGNSP PGUID 7877   18 t 0 ));
DATA(insert OID = 1114 ( 4434 date_ops    PGNSP PGUID 7873 1082 t 0 ));
DATA(insert OID = 1115 ( 4434 float4_ops  PGNSP PGUID 7876  700 t 0 ));
DATA(insert OID = 1116 ( 4434 float8_ops  PGNSP PGUID 7876  701 t 0 ));
DATA(insert OID = 1117 ( 4434 int2_ops    PGNSP PGUID 7871   21 t 0 ));
DATA(insert OID = 1118 ( 4434 int4_ops    PGNSP PGUID 7871   23 t 0 ));
DATA(insert OID = 1119 ( 4434 int8_ops    PGNSP PGUID 7871   20 t 0 ));
DATA(insert OID = 1120 ( 4434 name_ops    PGNSP PGUID 7878   19 t 2275 ));
DATA(insert OID = 1121 ( 4434 numeric_ops PGNSP PGUID 7882 1700 t 0 ));
DATA(insert OID = 1122 ( 4434 oid_ops     PGNSP PGUID 7872   26 t 0 ));
DATA(insert OID = 1123 ( 4434 text_ops    PGNSP PGUID 7887   25 t 0 ));
DATA(insert OID = 1124 ( 4434 time_ops    PGNSP PGUID 7874 1083 t 0 ));
DATA(insert OID = 1125 ( 4434 timestamptz_ops PGNSP PGUID 7873 1184 t 0 ));
DATA(insert OID = 1126 ( 4434 timetz_ops  PGNSP PGUID 7875 1266 t 0 ));
DATA(insert OID = 1127 ( 4434 varchar_ops PGNSP PGUID 7887   25 f 0 ));
DATA(insert OID = 1128 ( 4434 timestamp_ops   PGNSP PGUID 7873 1114 t 0 ));
DATA(insert OID = 1129 ( 4434 enum_ops    PGNSP PGUID 7886  3500 t 0 ));
DATA(insert OID = 1130 ( 4434 int1_ops    PGNSP PGUID 7884  5545 t 0 ));
DATA(insert OID = 1134 ( 4434 uuid_ops    PGNSP PGUID 7892  2950 t 0 ));
DATA(insert OID = 1138 ( 4434 interval_ops PGNSP PGUID 7883 1186 t 0 ));
