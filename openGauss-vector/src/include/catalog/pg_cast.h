...
/*floatvector related*/
/*int4[] -> floatvector*/
DATA(insert ( 1007 5036 5040 i f _null_));
/*float4[]-> floatvector*/
DATA(insert ( 1021 5036 5040 i f _null_));
/*float8[]-> floatvector*/
DATA(insert ( 1022 5036 5040 i f _null_));
/*numeric[]-> floatvector*/
DATA(insert ( 1231 5036 5040 i f _null_));
/*floatvector-> floatvector*/
DATA(insert ( 5036 5036 5064 i f _null_));


/*halfvector related*/
/*int4[] -> halfvector*/
DATA(insert ( 1007 5068 4590 i f _null_));
/*float4[]-> halfvector*/
DATA(insert ( 1021 5068 4590 i f _null_));
/*float8[]-> halfvector*/
DATA(insert ( 1022 5068 4590 i f _null_));
/*numeric[]-> halfvector*/
DATA(insert ( 1231 5068 4590 i f _null_));
/*halfvector-> halfvector*/
DATA(insert ( 5068 5068 4594 i f _null_));
/*floatvector-> halfvector*/
DATA(insert OID = 1000 ( 5036 5068 4595 i f _null_));
