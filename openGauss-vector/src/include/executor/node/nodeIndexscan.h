...
/*
 * These routines are exported to share code with nodeIndexonlyscan.c, nodeVectorIndexscan.cpp,
 * nodeTextMatchIndexscan.cpp and nodeBitmapIndexscan.c
 */
...
extern void ExecInitIndexRelation(IndexScanState* node, EState* estate, int eflags);
