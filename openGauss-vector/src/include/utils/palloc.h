 ...
 */
extern char* MemoryContextStrdupDebug(MemoryContext context, const char* string, const char* file, int line);
extern void MemoryContextCheckSessionMemory(MemoryContext context, Size size, const char* file, int line);
extern void MemoryContextCheckMaxSize(MemoryContext context, Size size, const char* file, int line);
