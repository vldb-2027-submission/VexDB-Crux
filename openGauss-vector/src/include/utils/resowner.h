...
/* support for vector buffer refcount management */
extern void ResourceOwnerEnlargeVectorBuffers(ResourceOwner owner);
extern void ResourceOwnerRememberVectorBuffer(ResourceOwner owner, const VecBufferLoc &buffer);
extern void ResourceOwnerForgetVectorBuffer(ResourceOwner owner, const VecBufferLoc &buffer);

/* support for bm25 dict refcount management */
extern void ResourceOwnerEnlargeBm25Dicts(ResourceOwner owner);
extern void ResourceOwnerRememberBm25Dict(ResourceOwner owner, const void *dict);
extern void ResourceOwnerForgetBm25Dict(ResourceOwner owner, const void *dict);
