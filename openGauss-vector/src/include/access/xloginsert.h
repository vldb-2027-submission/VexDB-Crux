...
extern void log_newpage_range(Relation rel, ForkNumber forknum, BlockNumber startblkindex,
                              BlockNumber endblkindex, bool page_std, RmgrId rmid, uint8 info,
                              BlockNumber *startblkno = NULL, bool do_report = false);
#endif /* XLOGINSERT_H */
