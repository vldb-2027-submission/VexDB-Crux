...
typedef enum {
    ...
    BLOCK_DATA_VECTOR_TYPE,
    BLOCK_DATA_HNSW_VECTOR_TYPE,
} XLogBlockParseEnum;
...
extern bool XLog_Write_N_bytes(uint64 values, Size writebytes, byte_t* buffer);
...
typedef struct XLogBlockEnCode {
    bool (*xlog_encodefun)(byte_t* buffer, Size buffersize, Size* encodesize, void* xlogbody);
    uint16 block_valid;
} XLogBlockEnCode;
...
typedef struct {
    ...
    union {
        ...
        XLogBlockVectorParse blockvectorec;
    } extra_rec;
} XLogBlockParse;
...
extern Size SalEncodeXLogBlock(void* recordblockstate, byte_t* buffer, void* sliceinfo);
...
extern XLogRecParseState *IvfRedoParseToBlock(XLogReaderState *record, uint32 *blocknum);
extern void IvfRedoDataBlock(XLogBlockHead *blockhead, XLogBlockDataParse *blockdatarec, RedoBufferInfo *bufferinfo);
extern XLogRecParseState *HnswRedoParseToBlock(XLogReaderState *record, uint32 *blocknum);
extern void HnswRedoDataBlock(XLogBlockHead *blockhead, XLogBlockDataParse *blockdatarec, RedoBufferInfo *bufferinfo);
extern XLogRecParseState *DiskannRedoParseToBlock(XLogReaderState *record, uint32 *blocknum);
extern void DiskannRedoDataBlock(XLogBlockHead *blockhead, XLogBlockDataParse *blockdatarec, RedoBufferInfo *bufferinfo);
extern XLogRecParseState *HybridRedoParseToBlock(XLogReaderState *record, uint32 *blocknum);
extern void HybridRedoDataBlock(XLogBlockHead *blockhead, XLogBlockDataParse *blockdatarec, RedoBufferInfo *bufferinfo);
extern XLogRecParseState *VectorIndexRedoParseToBlock(XLogReaderState *record, uint32 *blocknum);
extern void VectorIndexRedoDataBlock(XLogBlockHead *blockhead, XLogBlockDataParse *blockdatarec, RedoBufferInfo *bufferinfo);
extern void XLogBlockDoVectorAction(XLogRecParseState *preState);
extern void XLogBlockDoHnswVectorAction(XLogRecParseState *preState);
extern XLogRecParseState *Bm25RedoParseToBlock(XLogReaderState *record, uint32 *blocknum);
extern void Bm25RedoDataBlock(XLogBlockHead *blockhead, XLogBlockDataParse *blockdatarec, RedoBufferInfo *bufferinfo);
#endif