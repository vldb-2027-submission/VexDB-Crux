 ...
 *
 * skey.h
 *	  openGauss scan key definitions.
 *
 *
...
typedef struct ScanKeyData {
    uint32 sk_flags;            /* flags, see below */
    ...
    union {
        ...
        float sk_weight;        /* weight for bm25 index */
    };
 ...
 */
extern void ScanKeyInit(
    ScanKey entry, AttrNumber attribute_number, StrategyNumber strategy, RegProcedure procedure, Datum argument);
extern void ScanKeyEntryInitialize(ScanKey entry, uint32 flags, AttrNumber attribute_number, StrategyNumber strategy,
    Oid subtype, Oid collation, RegProcedure procedure, Datum argument);
extern void ScanKeyEntryInitializeWithInfo(ScanKey entry, uint32 flags, AttrNumber attribute_number,
    StrategyNumber strategy, Oid subtype, Oid collation, FmgrInfo* finfo, Datum argument);
