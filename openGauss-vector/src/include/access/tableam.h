...
static inline double tableam_index_build_range_scan(Relation heapRelation,
							  Relation indexRelation,
							  IndexInfo *indexInfo,
							  bool allow_sync,
							  bool anyvisible,
							  ...
							  TableScanDesc scan)
{
    return heapRelation->rd_tam_ops->index_build_range_scan(heapRelation, indexRelation, indexInfo,
