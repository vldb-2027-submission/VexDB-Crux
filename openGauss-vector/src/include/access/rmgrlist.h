...
PG_RMGR(RM_COMPRESSION_REL_ID, "CompressionRelation", CfsShrinkRedo, CfsShrinkDesc, NULL, NULL, NULL, NULL, NULL, \
    CfsShrinkTypeName)
PG_RMGR(RM_IVF_ID, "Ivf", ivf_redo, ivf_desc, NULL, NULL, NULL, NULL, NULL, ivf_type_name)
PG_RMGR(RM_HNSW_ID, "Hnsw", hnsw_redo, hnsw_desc, NULL, NULL, NULL, NULL, NULL, hnsw_type_name)
PG_RMGR(RM_DISKANN_ID, "Diskann", diskann_redo, diskann_desc, NULL, NULL, NULL, NULL, NULL, diskann_type_name)
PG_RMGR(RM_HYBRIDBT_ID, "HybridBt", hybrid_redo, hybrid_desc, NULL, NULL, NULL, NULL, NULL, hybrid_type_name)
PG_RMGR(RM_VECTORINDEX_ID, "vectorIndex", vectorindex_redo, vectorindex_desc, NULL, NULL, NULL, NULL, NULL, vectorindex_type_name)
PG_RMGR(RM_BM25_ID, "bm25", bm25_redo, bm25_desc, NULL, NULL, NULL, NULL, NULL, bm25_type_name)