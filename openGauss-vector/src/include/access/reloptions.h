...
typedef enum relopt_kind {
    ...
    RELOPT_KIND_IVFFLAT = (1 << 14),
    RELOPT_KIND_DISKANN = (1 << 15),
    RELOPT_KIND_BM25 = (1 << 16),
    RELOPT_KIND_HNSW = (1 << 17),
    RELOPT_KIND_IVFPQ = (1 << 18),
    RELOPT_KIND_HYBRIDANN = (1 << 19),
    RELOPT_KIND_PPARSER = (1 << 20), /* text search configuration options defined by pound */
