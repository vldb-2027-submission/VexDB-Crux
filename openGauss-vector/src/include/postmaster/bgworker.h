...
extern int LaunchBackgroundWorkers(int nworkers, void *bgshared, bgworker_main bgmain, bgworker_exit bgexit,  bool withLockGroupLeader = true);
...
extern void BgworkerListWaitStart(int *nparticipants);
extern void BgworkerListCheckStatus();
