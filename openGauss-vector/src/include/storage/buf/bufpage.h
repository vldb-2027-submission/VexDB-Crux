...
extern bool PageIsUnused(Page page);
...
extern OffsetNumber PageFindUnsedlp(Page page);
...
extern void PageIndexMultiSetUnused(Page page, OffsetNumber* itemnos, int nitems);
