...
extern void on_proc_exit(pg_on_exit_callback function, Datum arg, bool check_unique = false);
extern bool cancel_proc_exit(pg_on_exit_callback function, Datum arg);
