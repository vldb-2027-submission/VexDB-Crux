    ...
    Plan* plan, char** pname, char** sname, char** strategy, char** operation, char** pt_operation, char** pt_options)
{
    ...
    switch (nodeTag(plan)) {
        ...
        case T_VectorIndexScan:
            *pt_operation = "INDEX";
            if (((VectorIndexScan*)plan)->scan.isPartTbl)
        ...
        case T_TextMatchIndexScan:
            *pt_operation = "INDEX";
            if (((TextMatchIndexScan*)plan)->scan.isPartTbl)
                *pname = *sname = *pt_options = "Partitioned Text Match Index Scan";
            else
                *pname = *sname = *pt_options = "Text Match Index Scan";
            break;
