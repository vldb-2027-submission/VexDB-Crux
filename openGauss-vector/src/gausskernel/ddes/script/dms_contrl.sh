...
GSDB_BIN=${GAUSSHOME}/bin/vexdb
BIN_PATH=${GAUSSHOME}/bin
SCRIPT_NAME=$0

usage()
{
    echo "Usage: $0 [cmd] [vexdb_id] [GSDB_HOME] [DSS_HOME]"
    echo "cmd:"
    ...
    echo "    -reg: register vexdb"
    echo "    -unreg: unregister vexdb"
    echo "    -isreg: check whether vexdb is registered"
    echo "vexdb_id:"
    echo "    vexdb id"
    echo "GSDB_HOME:"
