...
bool is_feature_disabled(feature_name feature)
{
    ...
    /* The liccense control does not support the VexDB 300 product. */
...
{
    /* Only VexDB200 support the license resume operation. */
...
void initialize_feature_flags()
{
    ...
    /* Only VexDB200 support the license operation. */
    if (get_product_version() != PRODUCT_VERSION_GAUSSDB200) {
        return;
    }
