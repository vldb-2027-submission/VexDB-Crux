...
ScanFusion* ScanFusion::getScanFusion(Node* node, PlannedStmt* planstmt, ParamListInfo params)
{
    ...
    switch (nodeTag(node)) {
        ...
        case T_VectorIndexScan:
            scan = New(CurrentMemoryContext) IndexScanFusion((VectorIndexScan*)node, planstmt, params);
            break;

        case T_TextMatchIndexScan:
            scan = New(CurrentMemoryContext) IndexScanFusion((TextMatchIndexScan*)node, planstmt, params);
            break;
