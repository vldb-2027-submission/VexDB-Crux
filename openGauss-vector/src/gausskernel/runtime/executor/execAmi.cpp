...
void ExecReScanByType(PlanState* node)
{
    ...
    switch (nodeTag(node)) {
        ...
        case T_VectorIndexScanState:
            ExecReScanVectorIndexScan((VectorIndexScanState*)node);
            break;

        case T_TextMatchIndexScanState:
            ExecReScanTextMatchIndexScan((TextMatchIndexScanState*)node);
            break;
...
void ExecMarkPos(PlanState* node)
{
    switch (nodeTag(node)) {
        ...
        case T_VectorIndexScanState:
            ExecVectorIndexMarkPos((VectorIndexScanState*)node);
            break;

        case T_TextMatchIndexScanState:
            ExecTextMatchIndexMarkPos((TextMatchIndexScanState*)node);
            break;
...
void ExecRestrPos(PlanState* node)
{
    switch (nodeTag(node)) {
        ...
        case T_VectorIndexScanState:
            ExecVectorIndexRestrPos((VectorIndexScanState*)node);
            break;

        case T_TextMatchIndexScanState:
            ExecTextMatchIndexRestrPos((TextMatchIndexScanState*)node);
            break;
