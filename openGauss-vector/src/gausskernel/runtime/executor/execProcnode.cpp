...
PlanState* ExecInitNodeByType(Plan* node, EState* estate, int eflags)
{
    switch (nodeTag(node)) {
        ...
        case T_VectorIndexScan:
            return (PlanState*)ExecInitVectorIndexScan((VectorIndexScan*)node, estate, eflags);
        case T_TextMatchIndexScan:
            return (PlanState*)ExecInitTextMatchIndexScan((TextMatchIndexScan*)node, estate, eflags);
        case T_BitmapIndexScan:
...
static void ExecEndNodeByType(PlanState* node)
{
    ...
    switch (nodeTag(node)) {
        ...
        case T_VectorIndexScanState:
            ExecEndVectorIndexScan((VectorIndexScanState*)node);
            break;
        
        case T_TextMatchIndexScanState:
            ExecEndTextMatchIndexScan((TextMatchIndexScanState*)node);
            break;
