...
double HeapamIndexBuildRangeScan(Relation heapRelation,
							  ...
							  TableScanDesc scan)
{
    return IndexBuildHeapRangeScan(heapRelation, indexRelation, indexInfo,
        allow_sync, anyvisible, progress, start_blockno, numblocks, callback, callback_state, scan);
}
...
static const TableAmRoutine g_heapam_methods = {
    ...
    index_build_range_scan : HeapamIndexBuildRangeScan,
